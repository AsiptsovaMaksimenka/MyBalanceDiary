...
public class FoodRecyclerViewMainSnacks extends Fragment {

    private static final String ARG_MOVIE = "R.id.mdf_main_replace";
    FoodDataJson foodData;
    private FoodSnacksAdapter mRecyclerViewAdapter;
    ...
    public FoodRecyclerViewMainSnacks() {

    }

    public static FoodRecyclerViewMainSnacks newInstance() {
        FoodRecyclerViewMainSnacks fragment = new FoodRecyclerViewMainSnacks();
        Bundle args = new Bundle();
        args.putSerializable(ARG_MOVIE, "R.id.rcmainSnacks");
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.activity_recyclerview_snacks, container, false);
        RecyclerView mRecyclerView = rootView.findViewById(R.id.cardList);
        mRecyclerView.setHasFixedSize(true);
        RecyclerView.LayoutManager mLayoutManager = new LinearLayoutManager(getActivity());
        mRecyclerView.setLayoutManager(mLayoutManager);
        mRecyclerViewAdapter = new FoodSnacksAdapter(getActivity(), foodData.foodList);
        mRecyclerView.setAdapter(mRecyclerViewAdapter);
        voice = rootView.findViewById(R.id.vsfbSnacks);
    ...
    private class MyDownloadJsonAsyncTask extends AsyncTask<String, Void, FoodDataJson> {
        private final WeakReference<FoodSnacksAdapter> adapterReference;

        public MyDownloadJsonAsyncTask(FoodSnacksAdapter adapter) {
        ...
        protected void onPostExecute(FoodDataJson threadMovieData) {
            ...
            final FoodSnacksAdapter adapter = adapterReference.get();
            if (adapter != null) {
