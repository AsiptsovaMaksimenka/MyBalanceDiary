...
public class FoodRecyclerViewMainLunch extends Fragment {
    ...
    private FoodLunchAdapter mRecyclerViewAdapter;
    ...
    public FoodRecyclerViewMainLunch() {

    }

    public static FoodRecyclerViewMainLunch newInstance() {
        FoodRecyclerViewMainLunch fragment = new FoodRecyclerViewMainLunch();
        Bundle args = new Bundle();
        args.putSerializable(ARG_MOVIE, "R.id.rcmainLunch");
    ...
    private class MyDownloadJsonAsyncTask extends AsyncTask<String, Void, FoodDataJson> {
        private final WeakReference<FoodLunchAdapter> adapterReference;

        public MyDownloadJsonAsyncTask(FoodLunchAdapter adapter) {
        ...
        protected void onPostExecute(FoodDataJson threadMovieData) {
            ...
            final FoodLunchAdapter adapter = adapterReference.get();
            if (adapter != null) {
