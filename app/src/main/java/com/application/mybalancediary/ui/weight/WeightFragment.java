...
public class WeightFragment extends Fragment {
    ...
    public float currentWeight,ChangeWeight;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        FirebaseDatabase.getInstance().getReference("Users")
                ...
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        for (DataSnapshot ds : snapshot.getChildren()) {
                            currentWeight = Float.valueOf(String.valueOf(ds.child("weight").getValue()));
                            statCurWt.setText(String.valueOf(currentWeight));
            ...
            public void onClick(View v) {
                if (UserList.size() < 1) {
                    ...
                    for (int i = 2;i<number_of_values_in_the_graph+2;i++) {
                        ...
                        seriesGoal.appendData(new DataPoint(i+1, currentWeight), false, 10);
                    }
            ...
            public void onClick(View v) {
                if (UserList.size() < 32) {
                    ...
                    for (int i = 2;i<number_of_values_in_the_graph+2;i++) {
                        ...
                        seriesGoal.appendData(new DataPoint(i+1, currentWeight), false, 7);
                    }
                    graph.addSeries(seriesGoal);
