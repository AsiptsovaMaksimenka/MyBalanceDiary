...
public class FoodRecyclerViewMainBreakfast extends Fragment {

    private static final String ARG_MOVIE = "R.id.mdf_main_replace";
    FoodDataJson foodData;
    private FoodBreakfastAdapter mRecyclerViewAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mRecyclerViewAdapter = new FoodBreakfastAdapter(getActivity(), foodData.foodList);
    ...
    private class MyDownloadJsonAsyncTask extends AsyncTask<String, Void, FoodDataJson> {
        private final WeakReference<FoodBreakfastAdapter> adapterReference;

        public MyDownloadJsonAsyncTask(FoodBreakfastAdapter adapter) {
        ...
        protected void onPostExecute(FoodDataJson threadMovieData) {
            ...
            final FoodBreakfastAdapter adapter = adapterReference.get();
            if (adapter != null) {
